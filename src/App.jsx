...
export function App() {
  ...
  return (
    <CartProvider>
      <div className="min-h-screen bg-dot-grid-canvas text-nearblack flex flex-col font-sans selection:bg-[#DD6B80] selection:text-white overflow-x-hidden w-full max-w-full">
